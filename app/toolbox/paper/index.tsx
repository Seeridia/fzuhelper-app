...
export default function PaperPage() {
  ...
  const params = useMemo(() => ({ path: currentPath }), [currentPath]);
  const { data: paperData, loadingState, refetch } = useApiRequest(getApiV1PaperList, params);
    ...
    <>
      ...
      <PageContainer>
        ...
        <PaperList
          ...
          isRefreshing={loadingState === LoadingState.PENDING}
          onRefresh={refetch}
        />
      </PageContainer>
    </>
